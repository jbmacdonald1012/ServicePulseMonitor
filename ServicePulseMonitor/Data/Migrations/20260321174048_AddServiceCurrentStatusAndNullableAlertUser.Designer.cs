...
namespace ServicePulseMonitor.Data.Migrations
{
    ...
    [Migration("20260321174048_AddServiceCurrentStatusAndNullableAlertUser")]
    partial class AddServiceCurrentStatusAndNullableAlertUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ServicePulseMonitor.Data.Models.Alert", b =>
                {
            ...
            modelBuilder.Entity("ServicePulseMonitor.Data.Models.AlertRule", b =>
                {
            ...
            modelBuilder.Entity("ServicePulseMonitor.Data.Models.HealthCheck", b =>
                {
            ...
            modelBuilder.Entity("ServicePulseMonitor.Data.Models.NotificationConfig", b =>
                {
            ...
            modelBuilder.Entity("ServicePulseMonitor.Data.Models.Service", b =>
                {
                    b.Property<long>("ServiceId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("ServicePulseMonitor.Data.Models.ServiceDependency", b =>
                {
            ...
            modelBuilder.Entity("ServicePulseMonitor.Data.Models.User", b =>
                {
                    b.Property<Guid>("UserGuid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("ServicePulseMonitor.Data.Models.Alert", b =>
                {
                    b.HasOne("ServicePulseMonitor.Data.Models.Service", "Service")
                        .WithMany("Alerts")
                        .HasForeignKey("ServiceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ServicePulseMonitor.Data.Models.User", "User")
                        .WithMany("Alerts")
            ...
            modelBuilder.Entity("ServicePulseMonitor.Data.Models.NotificationConfig", b =>
                {
                    b.HasOne("ServicePulseMonitor.Data.Models.AlertRule", "AlertRule")
            ...
            modelBuilder.Entity("ServicePulseMonitor.Data.Models.ServiceDependency", b =>
                {
                    b.HasOne("ServicePulseMonitor.Data.Models.Service", "Callee")
                        .WithMany("CallingServices")
                        .HasForeignKey("DependsOnServiceId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("ServicePulseMonitor.Data.Models.Service", "Caller")
